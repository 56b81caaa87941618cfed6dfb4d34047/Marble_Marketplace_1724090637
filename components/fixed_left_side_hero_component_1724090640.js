...
*/
Vue.component("fixed_left_side_hero_component_1724090640", {
    template: `
            ...
            <div class="min-h-full w-full max-w-xl mx-auto flex flex-col justify-start px-4 sm:px-6 pt-36 pb-20 lg:py-20 flex-1" id="quote-header">
                <div class="grow flex flex-col justify-center" id="quote-content">
                    <div class="space-y-3" id="quote-container">
                        ...
                        <h1 id="company-name" class="h1 font-orbiter font-bold text-white">Marvelous Marbles</h1>
                        <time id="quote-date" class="block font-caveat text-xl text-slate-400">Your one-stop shop for collecting, trading, and showcasing unique marbles from around the globe</time>
                    </div>
                </div>
            </div>
        </div>
